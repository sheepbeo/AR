...
public class CustomPinchRecognizer : TKAbstractGestureRecognizer {

	public event Action<CustomPinchRecognizer> gestureRecognizedEvent;
	public event Action<CustomPinchRecognizer> gestureCompleteEvent;
